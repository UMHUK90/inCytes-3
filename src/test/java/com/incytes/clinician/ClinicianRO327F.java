...
public class ClinicianRO327F {
    ...
    public void method(){
        ...
        reportBuilder.selectCohort_Cohort("Text Test Question #2");
        ...
        $(byText("Commence avec")).waitUntil(Condition.visible, 5000).shouldBe(Condition.visible);
        $(byText("Se termine par")).shouldBe(Condition.visible);
