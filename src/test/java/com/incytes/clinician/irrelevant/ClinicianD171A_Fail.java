...
public class ClinicianD171A_Fail {
    @Test
    public void method(){
        ...
        $(byText("$25.00")).shouldBe(Condition.visible);
        $(byText("new monthly cost")).shouldBe(Condition.visible);
        $(byText("You are adding 0 cases. Select the pay button to pay with visa ending in 1111")).shouldBe(Condition.visible);
