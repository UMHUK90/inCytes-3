...
public class PatientPA181E {
    ...
    public void c_test() {
        ...
        $(name("countryName")).setValue("b");
        $(byAttribute("role", "tooltip")).shouldBe(visible);
        $("#react-autowhatever-1--item-0").shouldHave(text("Bahamas"));
        $("#react-autowhatever-1--item-1").shouldHave(text("Bahrain"));
        $("#react-autowhatever-1--item-2").shouldHave(text("Bangladesh"));
        $("#react-autowhatever-1--item-3").shouldHave(text("Barbados"));
        $("#react-autowhatever-1--item-4").shouldHave(text("Balarus"));
    }
}
