...
public class PatientPA181I {
    ...
    public void c_test() {
        ...
        $(name("firstName")).shouldBe(visible).click();
        $(name("lastName")).shouldBe(visible).click();
        $(name("birthDate")).shouldBe(visible).click();
        $(name("countryName")).shouldBe(visible).click();
        $(name("phoneNumber")).shouldBe(visible).click();
        $$(".Mui-error").shouldHave(size(5));
    }
}
