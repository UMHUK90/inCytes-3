...
public class PatientPA181M {
    ...
    public void c_test() {
        ...
        $(name("phoneNumber")).shouldHave(text("1234567890123456"));
        ...
        $(".Mui-error").shouldHave(text("Patient enrollment limit for this account has been reached. Please try again later"));
    }
}
