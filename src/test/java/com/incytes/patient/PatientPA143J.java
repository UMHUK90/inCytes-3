...
public class PatientPA143J {
    ...
    public void c_test() {
        ...
        home.setAllPassword_changePassword(Main.password, Main.randomText(7).toUpperCase() +"5", Main.password).writeAll_changePassword().checkAll_changePassword();
