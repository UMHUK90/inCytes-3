...
public class PatientPA182D {
    ...
    public void c_test() {
        ...
        reg.eTextOfCheckBox1().shouldHave(Condition.text("Términos y Condiciones"));
        reg.eTextOfCheckBox2().shouldHave(Condition.text("Términos y condiciones para profesionales sanitarios"));
    }
    @AfterMethod
